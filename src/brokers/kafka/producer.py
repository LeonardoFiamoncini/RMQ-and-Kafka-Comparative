...
class KafkaProducerBroker(BaseBroker):
    ...
    def create_topic_for_queue_mode(self, topic_name: str = None, num_partitions: int = 3, replication_factor: int = 1) -> bool:
        """
        ...
        try:
            ...
            try:
                ...
                for topic_name, f in fs.items():
                    ...
                    self.logger.info(f"Tópico {topic_name} criado com sucesso para Queue Mode")
